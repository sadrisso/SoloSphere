...
const JobDetails = () => {
  ...
  const { category, description, job_title, date, max_price, min_price } = data;
  ...
  const handleSubmit = e => {
    ...
    try {
      axios.post("http://localhost:2000/add-bids", initialData)
    ...
    //PRICE VALIDATION
    if (initialData?.price > max_price) {
      return toast.error("Add price less then max price")
    }
  }
